...
export function listingFromDto(dto: any) {
  if (!dto) return null;
...
export function auctionCardFrom(dto: any) {
...
export function listingCardFrom(dto: any) {
  const seller = dto.seller || {};
  return {
    id: dto.id,
    image: firstImage(dto),
...
export function orderFromDto(dto: any, currentUserId?: any) {
  if (!dto) return null;
...
export function reviewFromDto(dto: any) {
  if (!dto) return null;
  return {
    id: dto.id,
    rating: dto.rating,
...
export function notificationFromDto(dto: any) {
  if (!dto) return null;
...
export function bidFromDto(dto: any, leaderId?: any) {
  if (!dto) return null;
  return {
    id: dto.id,
